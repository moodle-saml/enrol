...
/**
 * Saml enrolment plugin - support for user saml unenrolment.
 *
 * @package    enrol
 * @subpackage saml
...
$instance = $DB->get_record('enrol', ['id' => $enrolid, 'enrol' => 'saml'], '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/saml/unenrolself.php', ['enrolid' => $instance->id]);
...
if ($confirm and confirm_sesskey()) {
    ...
    add_to_log($course->id, 'course', 'unenrol', $url, $course->id);
...
$message = get_string('unenrolselfconfirm', 'enrol_saml', format_string($course->fullname));
